...
public class PinotHelixResourceManagerStatelessTest extends ControllerTest {
  ...
  public void testGetLiveBrokers()
    ...
    Map<String, List<InstanceInfo>> liveBrokerInstanceMappingForTable = _helixResourceManager.getTableToLiveBrokersMapping(Optional.ofNullable(RAW_TABLE_NAME));
    ...
    liveBrokerInstanceMappingForTable = _helixResourceManager.getTableToLiveBrokersMapping(Optional.ofNullable(OFFLINE_TABLE_NAME));
    ...
    assertThrows(TableNotFoundException.class, () -> _helixResourceManager.getTableToLiveBrokersMapping(Optional.ofNullable(REALTIME_TABLE_NAME)));
